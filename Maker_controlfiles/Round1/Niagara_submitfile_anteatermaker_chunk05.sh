...
#SBATCH --output=OUTPUT_R1_05_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job05
   (maker -cpus 10 -base Anteater_input -g Anteater_input_016.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_017.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_018.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_019.fasta) &
wait
