...
#SBATCH --output=OUTPUT_R1_11_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job11
   (maker -cpus 10 -base Anteater_input -g Anteater_input_040.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_041.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_042.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_043.fasta) &
wait
