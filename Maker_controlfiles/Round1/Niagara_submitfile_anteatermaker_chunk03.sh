...
#SBATCH --output=OUTPUT_R1_03_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job03
   (maker -cpus 10 -base Anteater_input -g Anteater_input_008.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_009.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_010.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_011.fasta) &
wait
