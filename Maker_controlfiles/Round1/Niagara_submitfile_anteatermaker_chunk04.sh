...
#SBATCH --output=OUTPUT_R1_04_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job04
   (maker -cpus 10 -base Anteater_input -g Anteater_input_012.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_013.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_014.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_015.fasta) &
wait
