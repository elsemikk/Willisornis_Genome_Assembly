...
#SBATCH --output=OUTPUT_R1_14_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job14
   (maker -cpus 10 -base Anteater_input -g Anteater_input_052.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_053.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_054.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_055.fasta) &
wait
