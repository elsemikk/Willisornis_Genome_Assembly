...
#SBATCH --output=OUTPUT_R1_06_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job06
   (maker -cpus 10 -base Anteater_input -g Anteater_input_020.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_021.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_022.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_023.fasta) &
wait
