...
#SBATCH --output=OUTPUT_R1_12_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job12
   (maker -cpus 10 -base Anteater_input -g Anteater_input_044.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_045.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_046.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_047.fasta) &
wait
