...
#automated code to run (don't change)
   cd $WD
   #job15
   (maker -cpus 10 -base Anteater_input -g Anteater_input_056.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_057.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_058.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_059.fasta) &
wait
