...
#SBATCH --output=OUTPUT_R1_07_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job07
   (maker -cpus 10 -base Anteater_input -g Anteater_input_024.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_025.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_026.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_027.fasta) &
wait
