...
#SBATCH --output=OUTPUT_R1_08_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job08
   (maker -cpus 10 -base Anteater_input -g Anteater_input_028.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_029.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_030.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_031.fasta) &
wait
