...
#SBATCH --output=OUTPUT_R1_02_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job02
   (maker -cpus 10 -base Anteater_input -g Anteater_input_004.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_005.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_006.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_007.fasta) &
wait
