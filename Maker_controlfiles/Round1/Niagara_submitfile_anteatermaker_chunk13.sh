...
#SBATCH --output=OUTPUT_R1_13_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job13
   (maker -cpus 10 -base Anteater_input -g Anteater_input_048.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_049.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_050.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_051.fasta) &
wait
