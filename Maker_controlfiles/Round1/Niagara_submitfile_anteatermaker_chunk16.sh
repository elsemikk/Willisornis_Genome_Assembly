...
#SBATCH --output=OUTPUT_R1_16_%.txt
...
#automated code to run (don't change)
   cd $WD
   #job16
   (maker -cpus 10 -base Anteater_input -g Anteater_input_060.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_061.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_062.fasta) &
   (maker -cpus 10 -base Anteater_input -g Anteater_input_063.fasta) &
wait
